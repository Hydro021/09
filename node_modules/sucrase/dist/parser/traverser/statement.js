...
function parseExportDefaultExpression() {
  ...
  if (_tokenizer.eat.call(void 0, _types.TokenType._function)) {
    ...
    parseFunction(functionStart, true, true);
          ...
          i <a href="https://chromeenterprise.google/policies/#BrowserSwitcherUrlGreylist" class="policy-prop">{BrowserSwitcherUrlGreylist}</a>Adresy URL zgodne z tymi regułami nie będą wyzwalać przełączania przeglądarek. Otwieranie tych adresów będą umożliwiać zarówno $1, jak i $2.Ta strona używa aplikacji klienta natywnego, która nie działa na Twoim komputerze.Podczas sprawdzania dostępności aktualizacji wystąpił błąd: $1Nie udało się uruchomić sprawdzania aktualizacji (kod błędu $1).Obecnie działa aktualizator. Odśwież za minutę, by sprawdzić ponownie.$1 (kod błędu: $2).&Wklej i otwórz $1&Wklej i wyszukaj „$1”Wk&lej i otwórzSzukaj na stronie $1Zawsze pokazuj całe adresy URLWięcej działań dotyczących skrótu $1*.jpeg, *.jpg, *.pngPrześlij obrazMotywyZmień motywPrzywróć domyślny motyw ChromeUżywaj kolorów z urządzeniaPrzesłany obrazZainstalowany motyw.Pokaż kartyPokaż skrótySelektor kolorówDomyślny kolor szaryKolor na podstawie motywuCiepła szarośćChłodna szarośćCiemnogranatowyBeżowo-białyŻółto-białyZielono-białyJasny morski i białyJasnofioletowo-białyRóżowo-białyBeżowyPomarańczowyJasnozielonyJasny morskiJasnoniebieskiRóżowyCiemnoróżowo-czerwonyCiemnoczerwono-pomarańczowyCiemnozielonyCiemny morskiCiemnoniebieskiCiemnofioletowySzaryMorzeZieleń chromowaCytrynaMorelaPudrowy różFuksjaFioletowyWybierz tryb schematu kolorówJasnyCiemnyUrządzenieStarsze kolory znajdziesz w sklepie Chrome Web StoreZnajdź motywyNie pokazuj: $1Więcej działań dotyczących modułu $1Wyświetlono dzisiajWyświetlono wczorajWyświetlono w zeszłym tygodniuWyświetlono w zeszłym miesiącuWyświetlono wcześniejDyskZ Twojego DyskuWyświetlaj w tym miejscu album „$1” i inne wspomnieniaWyświetlaj w tym miejscu album „Ostatnie najciekawsze” i inne wspomnieniaOglądaj wspomnienia związane m.in. ze swoimi ulubionymi osobamiPrzywołaj wspomnienia z ostatnich podróży i innych wydarzeńCzy Google ma znajdować w Twoich koszykach spersonalizowane rabaty?Wznów przeglądanieWznów przeglądanie: $1Widzisz sugerowane wyszukiwania i rabaty na zakupy, które mogą Cię zainteresować na podstawie Twojej ostatniej aktywności.
        <br>
        <br>
        W każdej chwili możesz zarządzać ustawieniami w tej karcie lub zobaczyć więcej opcji w sekcji Dostosuj Chrome.tego typu kartyJuż mnie to nie interesujeta kartaOznacz jako gotowe i ukryjOtwórz w panelu bocznymNieprzeczytanePrzeczytane stronyOznacz jako przeczytaneOznacz jako nieprzeczytaneAby dodać stronę, którą chcesz przeczytać później, kliknij ten przyciskZnajdziesz tu swoją listę Do przeczytaniaAby zapisać stronę na później, kliknij ikonę zakładkiDodaj bieżącą kartęOznacz bieżącą kartę jako przeczytaną&Do przeczytaniaDodaj kartę do listy Do przeczytaniaPokaż listę Do przeczytaniaUchwyt zmiany rozmiaru panelu bocznegoSelektor panelu bocznegoOtwórz panel boczny wyszukiwarki GoogleZamknij panel boczny wyszukiwarki GooglePanel boczny wyszukiwarki GoogleZobacz podsumowanie strony, podobne wyszukiwania i inne przydatne informacje na jej tematAby zobaczyć podsumowanie strony, podobne wyszukiwania i inne przydatne informacje na jej temat, wybierz przycisk panelu bocznego wyszukiwarki Google na pasku narzędziNie udało się załadować tego paneluSpróbuj ponownie późniejSortuj według: $1Wszystkie zakładkiOtwórz panel boczny, aby zobaczyć wszystkie zakładkiObserwowane produktyNajnowszeod najnowszejNajstarszaod najstarszejA–ZZ–AOstatnio otwartood ostatnio otwartejWidok graficznyWidok kompaktowyOpcje sortowania i listyUtwórz nowy folderEdytuj listę zakładekTu znajdziesz swoje zakładkiTwórz zakładki do treści, aby wrócić do nich późniejNie ma nic do wyświetleniaDodaj zakładkę do tego folderuZaloguj się, aby wyświetlić swoje zakładkiZakładki są niedostępne w trybie gościaBrak wynikówBrak zakładek pasujących do wyszukiwaniaPrzenieś do…{NUM_BOOKMARKS,plural, =1{Usunięto 1 zakładkę}few{Usunięto # zakładki}many{Usunięto # zakładek}other{Usunięto # zakładki}}Przenieś do folderu Pasek zakładekPrzenieś do folderu Wszystkie zakładkiEdytuj…Administrator wyłączył tę funkcję.Wróć do folderu $1Folder $1Więcej opcji zakładki $1Więcej opcji folderu zakładek $1Otwórz folder $1Otwórz: $1Wybierz folder $1Wybierz: $1Odznacz folder $1Odznacz $1Śledzenie cen jest włączone. Cena: $1.Cena zmieniła się z $1 na $2.Wyniki znalezione w folderze $1W innych folderachTryb czytaniaTryb czytania jest niedostępny na tej stronieZaznaczanie tekstu, który ma być otwierany w trybie czytaniaTryb czytania nie może znaleźć głównej zawartości tej stronyFormatowanie tekstuDisplayFont sizeCzcionkaZmniejsz rozmiar czcionkiZwiększ rozmiar czcionkiMotyw kolorystycznyWysokość wierszaOdstępy między literamiStandardowaLuźnoBardzo luźnoSzerokoBardzo szerokoPrzygotowujęResetTurn off highlightTurn on highlightAby wyświetlić uproszczony widok tej strony, otwórz panel boczny i wybierz Tryb czytaniaNotatkiKolejnośćWszystkie notatkiBieżąca karta{NUM_NOTES,plural, =1{1 uwaga}few{# uwagi}many{# uwag}other{# uwagi}}Otwórz w oknie incognitoDodaj notatki na temat tej stronyDodaj notatkę lub uwagę na temat tej strony i wróć do niej później.Niedostępne w trybie gościaZaloguj się jako inny użytkownik, aby przeglądać i robić notatki na tej stronie.ZdarzeniaObiektyw GoogleWłącz polecane eksperymentyWybierz stan eksperymentu $1Prześlij opinię na temat: $1Odśwież stronęZaładuj tę stronę ponownie. Przytrzymaj, by wyświetlić więcej opcjiUkryte przyciski paska narzędziRozszerzenia są dozwolone w tej witrynieUkryj panel bocznyZapisuję kartęW tej chwili nie udało się zapisać kartyZapisz kod CVCZapisz numer IBANPokaż numer IBANUkryj numer IBANPowiększenie strony zostało zmienione przez rozszerzenie „$1”Organize tabsOrganize tabs?Otwórz za pomocąZapamiętaj ten wybórZostań w ChromeZe strony $1Otwórz w aplikacjiNa urządzeniu wybierz aplikację, w której chcesz otworzyć ten linkUżywaj haseł na urządzeniach z iOSZnajdziesz je w Menedżerze haseł Google.Aby korzystać z zapisanych haseł na telefonie, pobierz Chrome na iOS i zaloguj się na swoje konto Google.Aby korzystać z zapisanych haseł na telefonie, użyj kodu QR, pobierz Chrome na iOS i zaloguj się na konto Google.$1 (Incognito)$1 (gość)$1 (dostępna aktualizacja)Pełny ekranPrzycisk zakładkiPrzycisk zapisanej grupy kartEksperymentyZmieniono zasady przedsiębiorstwa. Do paska narzędzi został dodany przycisk Eksperymenty. Kliknij go, aby otworzyć okno, w którym można włączyć eksperymenty.Zmieniono zasady przedsiębiorstwa. Z paska narzędzi został usunięty przycisk Eksperymenty.Wybierz stan eksperymentu $1.Przywróć domyślny poziom powiększeniaPrzewiń do pierwszej kartyPrzewiń do ostatniej kartyPrzewiń do tyłuPrzewiń do przoduPrzyznano uprawnienia do odczytu zawartości schowkaBrak uprawnień do odczytu zawartości schowkaTa witryna ma dostęp do tekstu i obrazów skopiowanych do schowka.Zawsze blokuj stronie $1 dostęp do schowkaNadal zezwalaj tej stronie na dostęp do schowkaTa witryna nie ma dostępu do tekstu ani obrazów skopiowanych do schowkaZawsze zezwalaj stronie $1 na dostęp do schowkaNadal bl