        ...
        matchUtilities({
            "backdrop-grayscale": (value)=>{
                return {
                    ...
                    "@defaults backdrocek bazı uzantıları devre dışı bıraktık.Chrome'u daha güvenli bir hale getirmek için $1 altında listelenmeyen ve bilginiz dışında eklenmiş olabilecek aşağıdaki uzantıyı devre dışı bıraktık.Google Chrome'u özelleştirin ve kontrol edin. Güncelleme mevcut.Google Chrome'u özelleştirin ve kontrol edin. İlgilenmeniz gereken bir konu var. Ayrıntılar için tıklayın.&Chrome'da aç&Google Chrome hakkında&Chrome'u güncellemek için yeniden başlatGüncellemek için yeniden başlatın. Sekmeleriniz yeniden açılır.Google Ş&ifre YöneticisiChrome'da $1 olarak oturum açtınız. Tekrar oturum açmak için lütfen aynı hesabı kullanın.Birisi daha önce bu bilgisayarda $1 olarak Chrome oturumu açmış. Bilgilerinizi ayrı tutmak için yeni bir Chrome kullanıcısı oluşturun.Chrome'da oturum açtınız!$1 olarak oturum açtınız. Şimdi oturum açtığınız tüm cihazlarda yer işaretlerinize, geçmişinize ve diğer ayarlarınıza erişebilirsiniz.Sistem yöneticiniz Google Chrome'u $1 adresine erişmek için alternatif bir tarayıcıyı açacak şekilde yapılandırmış.Sistem yöneticiniz Google Chrome'u $1 adresine erişmek için $2 tarayıcısını açacak şekilde yapılandırmış.$1 önceden Chrome kullanıyorduYeni bir Chrome profilinde devam edilsin mi?Mevcut Chrome profiline geçilsin mi?Bu hesaba sahip bir Chrome profili zaten var$1 kullanıcısının oturumu halihazırda bu Chrome profilinde açık. Göz atma işlemlerinizi ayrı tutmak isterseniz Chrome, sizin için kendi profilinizi oluşturabilir.$1 kullanıcısının oturumu halihazırda bu Chrome profilinde açık. Bu işlem, $2 için yeni bir Chrome profili oluşturacakBu işlem, $1 için yeni bir Chrome profili oluşturacakYeni Chrome profilinizi özelleştirinChrome UygulamalarıChrome Canary UygulamalarıChrome Beta UygulamalarıChrome Dev UygulamalarıGoogle Chrome kameranızı ve mikrofonunuzu kullanıyor.Google Chrome mikrofonunuzu kullanıyor.Google Chrome kameranızı kullanıyor.{NUM_DEVICES,plural, =0{Bir veya daha fazla Chrome uzantısı, 1 insan arabirim cihazına erişiyordu}=1{Bir veya daha fazla Chrome uzantısı, 1 insan arabirim cihazına erişiyor}other{Bir veya daha fazla Chrome uzantısı, # insan arabirim cihazına erişiyor}}{NUM_DEVICES,plural, =0{Bir veya daha fazla Chrome uzantısı, 1 USB cihazına erişiyordu}=1{Bir veya daha fazla Chrome uzantısı, 1 USB cihazına erişiyor}other{Bir veya daha fazla Chrome uzantısı, # USB cihazına erişiyor}}Chrome menüsünü tıklayın"Google Şifre Yöneticisi"ni tıklayınGoogle Şifre Yöneticisi'ne hızlıca gitmek için kısayolunuzu kullanın. Kısayolunuzu bilgisayarınızın ana ekranına veya uygulama başlatıcıya taşıyabilirsiniz.Google Şifre Yöneticisi için kısayol ekleyinBu uzantı, Chrome'u başlattığınızda gösterilen sayfayı değiştirdi."$1" uzantısı, Chrome'u başlattığınızda gösterilen sayfayı değiştirdi. Ayrıca Chrome'u başlattığınızda gösterilecek sayfayı da denetler.  Ayrıca Chrome'u başlattığınızda veya Ana Sayfa düğmesini tıkladığınızda gösterilecek sayfayı da denetler.  Ayrıca, Chrome'u başlattığınızda veya Çok Amaçlı Adres Çubuğu'ndan arama yaptığınızda gösterilecek sayfayı da denetler. Google Chrome (mDNS-In)Google Chrome Beta (mDNS-In)Google Chrome Canary (mDNS-In)Google Chrome Dev (mDNS-In)Google Chrome'un mDNS trafiğine izin vermeyi sağlayan gelen trafik kuralı.Google Chrome Beta'nın mDNS trafiğine izin vermeyi sağlayan gelen trafik kuralı.Google Chrome Canary'nin mDNS trafiğine izin vermeyi sağlayan gelen trafik kuralı.Google Chrome Dev'in mDNS trafiğine izin vermeyi sağlayan gelen trafik kuralı.Bir resmin işe yarar bir açıklaması yoksa, Chrome sizin için bir açıklama sağlamaya çalışır. Açıklama oluşturmak için resimler Google'a gönderilir. Bu özelliği istediğiniz zaman ayarlardan kapatabilirsiniz.Bir resmin işe yarar bir açıklaması yoksa, Chrome sizin için bir açıklama sağlamaya çalışır. Açıklama oluşturmak için resimler Google'a gönderilir.Bu işlev, Google Arama'da kullanılan yazım denetiminin aynısını kullanır. Tarayıcıda yazdığınız metin Google'a gönderilir. Bu davranışı istediğiniz zaman ayarlardan değiştirebilirsiniz.Bağlantıyı yeni Chrome &sekmesinde açBağlantıyı Chrome &gizli penceresinde açChrome'u Yeniden Başlat{COUNT,plural, =0{Chrome için yeni bir güncelleme var. Yeniden başlattığınızda güncelleme hemen uygulanacaktır.}=1{Chrome için yeni bir güncelleme var. Yeniden başlattığınızda güncelleme hemen uygulanacaktır. Gizli pencereniz yeniden açılmayacak.}other{Chrome için yeni bir güncelleme var. Yeniden başlattığınızda güncelleme hemen uygulanacaktır. # Gizli pencereniz yeniden açılmayacak.}}Yeniden başlatChrome güncellemesini tamamlamak için yeniden başlatın{COUNT,plural, =0{Chrome güncellemesi tamamlandı. Yeniden başlattığınızda son sürümü kullanabilirsiniz. Sonrasında mevcut sekmeleriniz yeniden açılır.}=1{Chrome güncellemesi tamamlandı. Yeniden başlattığınızda son sürümü kullanabilirsiniz. Sonrasında mevcut sekmeleriniz yeniden açılır. Gizli pencereniz yeniden açılmayacak.}other{Chrome güncellemesi tamamlandı. Yeniden başlattığınızda son sürümü kullanabilirsiniz. Sonrasında mevcut sekmeleriniz yeniden açılır. # gizli pencereniz yeniden açılmayacak.}}Chrome'u yeniden yükleChrome sürümü eskiChrome güncellenemiyorChrome en son sürüme güncellenemediği için yeni özellikler ve güvenlik düzeltmeleri cihazınızda bulunmuyor.Senkronizasyonu başlatmak için Chrome'u güncelleyinSon sürümde güvenlikle ilgili önemli iyileştirmeler ve yeni özellikler mevcuttur.Google Chrome $1 sonra yeniden başlatılacakLütfen Chrome'u şimdi yeniden başlatınGoogle Chrome için özel bir güvenlik güncellemesi uygulandı. Uygulamayı hemen yeniden başlatın; açık sekmeleriniz geri yüklenir.Chrome SekmesiChrome'a Hoş GeldinizChrome bildirim ayarlarına git{0,plural, =0{Bir Chrome güncellemesi var}=1{Bir Chrome güncellemesi var}other{# gün önce kullanıma sunulmuş bir Chrome güncellemesi var}}{COUNT,plural, =0{Yöneticiniz bu güncellemeyi uygulamak için Chrome'u yeniden başlatmanızı istiyor}=1{Yöneticiniz bu güncellemeyi uygulamak için Chrome'u yeniden başlatmanızı istiyor. Gizli pencereniz yeniden açılmayacak.}other{Yöneticiniz bu güncellemeyi uygulamak için Chrome'u yeniden başlatmanızı istiyor. # Gizli pencereniz yeniden açılmayacak.}}{0,plural, =1{Chrome'u bir gün içinde yeniden başlatın}other{Chrome'u # gün içinde yeniden başlatın}}{0,plural, =1{Chrome bir saat içinde yeniden başlatılacak}other{Chrome # saat içinde yeniden başlatılacak}}{0,plural, =